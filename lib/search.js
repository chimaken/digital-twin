 ...
 * Supports: Brave Search API (BRAVE_API_KEY) or DuckDuckGo Instant Answer (no key, free).
 */
 ...
 * Uses Brave if BRAVE_API_KEY is set, else DuckDuckGo (no key).
 * @param {string} query - Search query
 * @param {number} [num=5] - Max number of results
